...
<script type="text/javascript">
  ...
  var _gaq = _gaq || [];
  _gaq.push(['_setAccount', 'UA-12492184-1']);
	...
	<div id="header">
    	...
    	<div id="logo">
        	<a href="<?php echo home_url( '/' ); ?>"  title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel="home">
                 ...
                 <?php } else { ?>
                       <img src="<?php echo get_template_directory_uri(); ?>/images/light/heath-logo-h.png" alt="<?php bloginfo('sitename'); ?>">
                 <?php } ?>
            </a>
       ...
       <?php } else { ?>
 	 	 <div id="nav"><ul><?php wp_list_pages("depth=1&title_li=");  ?><?php wp_list_categories( 'depth=1&title_li=' ); ?></ul></div>
	   <?php } ?>
