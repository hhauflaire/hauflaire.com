...
<?php
  ...
  */
  ...
  private function addTextPart(& $message) {
     ...
     if (!empty ($message)) {
        ...
        $message = new src_mail_mimePart($this->text, $params);
  ...
  */
  ...
  private function addHtmlPart(& $message) {
     ...
     if (!empty ($message)) {
        ...
        $message = new src_mail_mimePart($this->html, $params);
  ...
  */
  ...
  private function addMixedPart(& $message) {
     ...
     $message = new src_mail_mimePart('', $params);
  ...
  public function send($recipients, $type = 'mail') {
     ...
     switch ($type) {
        ...
        case 'smtp' :
           ...
           $smtp = & src_mail_smtp :: connect($this->smtp_params);
           ...
           foreach ($recipients as $recipient) {
              ...
              $addresses = src_mail_RFC822 :: parseAddressList($recipient, $this->smtp_params['helo'], null, false);
           ...
           foreach ($this->headers as $name => $value) {
              ...
              if ($name == 'Cc' OR $name == 'Bcc') {
                 ...
                 $addresses = src_mail_RFC822 :: parseAddressList($value, $this->smtp_params['helo'], null, false);
           ...
           elseif (!empty ($this->headers['From'])) {
              ...
              $from = src_mail_RFC822 :: parseAddressList($this->headers['From']);
