...
<h3 class="sub"><?php echo "$featured_category"; ?></h3>
	...
	<?php while ($my_query->have_posts()) : $my_query->the_post();
		$do_not_duplicate = $post->ID; $i++; ?>
			<div class="span-8<?php if (($i%$col)==0) { ?> last<?php } ?>">
			<div class="post-<?php the_ID(); ?> portfolio-image-wrapper">			
			<?php get_the_image( "custom_key=thumbnail&default_size=thumbnail&width=310&height=150&image_class=attachment-thumbnail&default_image=$default_thumb" ); ?>			
